...
def pipeline(
    ...
    if reference_summary  :  
        ...
        rouge_results = {"result" : "None" , "cause" : "no reference summary provided"}
        blue_rt_scores =  {"result" : "None" , "cause" : "no reference summary provided"}
        bert_results =  {"result" : "None" , "cause" : "no reference summary provided"}
